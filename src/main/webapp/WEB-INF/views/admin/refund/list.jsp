...
<body>
	...
	<c:if test="${pu.startPageNum>5 }"><a href="${cp }/admin/refund/list?pageNum=${pu.startPageNum-1}">[이전페이지]</a></c:if>
	...
	<div class="text-center">
		<form:form method="post" action="${cp }/admin/refund/list">
			<select name="field">
				...
				<option value="ui_id" <c:if test="${field=='ui_id'}">selected</c:if>>주문자
					아이디</option>
			</select>
