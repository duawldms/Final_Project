...
public class GoCartController {
	...
	public HashMap<String, Object> gocart(@RequestParam(value="checkbox[]") List<String> checkbox,
			@RequestParam(value="optionscnt[]") List<String> optionscnt,int foodnum,
			@RequestParam(value="necoptions[]") List<String> nec,Model model,Principal principal) {
